...
catalog = '/Users/steven/Projects/cluster/data/boada/may_2012/catalogs/c210p27+2p87_complete.csv'

files = glob.glob('*.results')
center = 210.25819, 2.87851
...
cleaned.to_csv('c210p27+02p8_members.csv')
