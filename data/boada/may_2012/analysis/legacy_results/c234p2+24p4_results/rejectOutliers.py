...
catalog = '/Users/steven/Projects/cluster/data/boada/may_2012/catalogs/c234p2+24p4_complete.csv'

files = glob.glob('*.results')
center = 234.23439, 24.408778
...
cleaned.to_csv('c234p2+24p4_members.csv')
