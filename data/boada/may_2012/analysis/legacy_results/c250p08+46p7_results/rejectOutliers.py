...
catalog = '/Users/steven/Projects/cluster/data/boada/may_2012/catalogs/c250p08+46p7_complete.csv'

files = glob.glob('*.results')
center = 250.08255, 46.711531

results = parseResults(files)
matched = matchToCatalog(results, catalog)
matched = findSeperationSpatial(matched, center)
matched = findLOSV(matched)

cleaned = rejectInterlopers(matched)
cleaned.to_csv('c250p08+46p7_members.csv')
