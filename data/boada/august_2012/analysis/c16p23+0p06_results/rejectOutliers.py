...
catalog = '/Users/steven/Projects/cluster/data/boada/august_2012/catalogs/c16p23+0p06_complete.csv'

files = glob.glob('*.results')
center = 16.2307083333, 0.0600916666667
...
print len(cleaned)
cleaned.to_csv('c16p23+0p06_members.csv')
