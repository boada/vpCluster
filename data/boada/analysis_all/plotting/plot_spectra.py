...
ax[0].text(3933.68, 0.95, 'K', ha='center', va='top', size=11,
        rotation='vertical')
# H
ax[0].plot([3968.47,3968.47], [0,0.8], '--', c='k',lw=1)
ax[0].text(3968.47, 0.95, 'H', ha='center', va='top', size=11,
        rotation='vertical')
# G
ax[0].plot([4307.74,4307.74], [0,0.8], '--', c='k',lw=1)
ax[0].text(4307.74, 0.95, 'G', ha='center', va='top', size=11,
                rotation='vertical')

# [Oii]
ax[1].plot([3727.3,3727.3], [0,0.7], '--', c='k',lw=1)
ax[1].text(3727.3, 0.95, '$[O_{II}]$', ha='center', va='top', size=11,
                        rotation='vertical')
